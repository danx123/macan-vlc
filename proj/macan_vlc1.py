...
class ModernVideoPlayer(QWidget):
    ...
    def _setup_ui(self):
        self.setWindowTitle("Macan VLC Player")
        ...
        if os.path.exists(splash_path):
            ...
            self.splash_label.setText("Macan VLC Player")
    ...
    def _connect_signals(self):
        ...
        # FIX: Menambahkan koneksi untuk tombol Play/Pause dan Stop di mini player
    ...
    def _load_video_file(self, file_path_or_url):
        ...
        # FIX: Mengatur ulang volume player agar sesuai dengan UI sebelum play.
        # Ini mencegah slider reset ke posisi mute saat memuat video baru.
