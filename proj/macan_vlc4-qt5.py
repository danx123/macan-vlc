...
# --- PUSTAKA INTI YANG DIUBAH (MIGRASI KE PYQT5) ---
...
# --- KELAS-KELAS PEMBANTU (DENGAN PENYESUAIAN PYQT5) ---
...
class ModernVideoPlayer(QWidget):
    ...
    def __init__(self):
        ...
        self.setAcceptDrops(True)
        # video_frame tidak bisa setAcceptDrops, jadi kita set di parent
        self.setMouseTracking(True)
    ...
    def _setup_ui(self):
        self.setWindowTitle("Macan Video Player (PyQt5)")
